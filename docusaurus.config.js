...
const config = {
  title: 'Genshin College Alliance',
  ...
  organizationName: 'Genshin College Alliance', // Usually your GitHub org/user name.
  projectName: 'Genshin impact Start!', // Usually your repo name.
